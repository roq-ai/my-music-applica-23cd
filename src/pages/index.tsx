  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to My Music Application - Your ultimate hub for tracking new song releases, discovering platform links, and effortlessly sharing your favorite music across social media."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtdXNpY3xlbnwwfHx8fDE2OTI2MDMxMDN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to My Music Application - Your ultimate hub for tracking new song releases, discovering platform links, and effortlessly sharing your favorite music across social media.`}
            </Text>
            <Box
